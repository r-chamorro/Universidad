...
void typewritereffect::maquinaEscribir (string texto, int delayedby) //Funcion Para efecto maquina de escribir, recibe una variable de tipo string y un entero para el tiempo de espera
{
    {
